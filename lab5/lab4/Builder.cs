...
namespace lab3
{
    abstract class StudentStringBuilder
    {
        ...
        public abstract void BuildStudentCompanyInformation(Student st);
    }
    ...
    public StudentCompanyInformation StudentCompanyINFO { get; set; }
        ...
        public override string ToString()
        {
            ...
            if (StudentCompanyINFO != null)
            {
                sb.Append("Компания: " + StudentCompanyINFO.CompanyINFO +
                           "\nДолжность: " + StudentCompanyINFO.GradeINFO +
                           "\nСтаж: " + StudentCompanyINFO.ExpINFO);
            }
    ...
    class PrivateInformationBuilder : StudentStringBuilder
    {
        ...
        public override void BuildStudentCompanyInformation(Student st)
        {
    ...
    class CompanyInformationBuilder : StudentStringBuilder
    {
        public override void BuildStudentAdressInformation(Student st)
        {
        }
        public override void BuildStudentCompanyInformation(Student st)
        {
            this.info.StudentCompanyINFO = new StudentCompanyInformation();
            this.info.StudentCompanyINFO.CompanyINFO = st.company.company.ToString();
            this.info.StudentCompanyINFO.ExpINFO = st.company.exp.ToString();
            this.info.StudentCompanyINFO.GradeINFO = st.company.post.ToString();
        }
    ...
    class StudentDirector
    {
        public StudentInforamation BuildString(StudentStringBuilder studentStringBuilder,Student st)
        {
            ...
            studentStringBuilder.BuildStudentCompanyInformation(st);
